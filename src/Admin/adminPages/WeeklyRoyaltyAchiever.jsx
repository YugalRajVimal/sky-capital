  ...
  useEffect(() => {
    const handleGetAllWeekRoyaltyAchievers = async () => {
      try {
        ...
        if (achievers.WeekRoyaltyAchiever) {
          console.log(achievers.WeekRoyaltyAchiever);
          const temp = achievers.WeekRoyaltyAchiever;
...
export default WeeklyRoyaltyAchiever;
