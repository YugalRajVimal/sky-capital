  ...
  return (
    <div className="bg-white max-h-full rounded-xl shadow-lg w-full max-w-6xl mx-auto my-10 overflow-y-auto">
      ...
      <div className="px-4 py-3">
        <h2 className="text-black font-semibold text-lg">Deposit History</h2>
      </div>
            ...
            {currentItems?.length === 0 ? (
              ...
              currentItems.map((item, idx) => (
                <tr key={item._id || idx} className="even:bg-gray-50">
                  ...
                  <td className="px-4 py-2">{item?.recieverUserId?.name}</td>
                  <td className="px-4 py-2">{item?.recieverUserId?._id}</td>
                  <td className="px-4 py-2">{item?.recieverUserId?.email}</td>
                  <td className="px-4 py-2">
